      ...
      <main>
        <section className="relative overflow-hidden border-t border-ink/5 px-5 pb-20 pt-12 sm:pt-16 lg:pb-28">
          ...
          <div className="relative mx-auto max-w-6xl text-center">
            ...
            <p className="mx-auto mt-8 max-w-2xl text-sm font-semibold leading-7 text-muted sm:text-base">
              ...
              pertanyaan adaptif, dan feedback yang fokus pada kualitas jawaban.
            </p>
            ...
            <div className="grid gap-10 lg:grid-cols-[0.85fr_1.15fr]">
              <ScrollReveal>
                <SectionHeader
                  ...
                  description="Mahasiswa dan fresh graduate sering punya project, organisasi, bootcamp, atau magang, tetapi jawaban interview masih terlalu umum dan kurang evidence."
                />
              </ScrollReveal>
        ...
        <section className="px-5 py-24">
          <ScrollReveal className="mx-auto max-w-6xl">
            <SectionHeader
              eyebrow="Solusi"
              title="Road2Work mengubah CV dan konteks profil menjadi latihan interview yang terarah."
              description="Setiap sesi berfokus pada satu keputusan utama: pilih role, beri konteks, jawab dengan suara, lalu review dashboard yang actionable."
            />
            <WorkflowTimeline />
          </ScrollReveal>
        </section>
        ...
        <section id="features" className="bg-white px-5 py-24">
          <div className="mx-auto max-w-6xl">
            <ScrollReveal>
              <SectionHeader eyebrow="Features" title="Semua yang dibutuhkan untuk flow interview MVP." />
            </ScrollReveal>
          ...
          <ScrollReveal className="mx-auto max-w-6xl">
            <div className="grid items-center gap-10 lg:grid-cols-[0.9fr_1.1fr]">
              <SectionHeader
                ...
                title="Latihan untuk role yang menjadi fokus MVP."
                description="Role coverage sengaja dikunci agar pertanyaan, rubric, dan dashboard tetap relevan untuk demo capstone."
              />
